...
const popularDishes = [
  {
    ...
    description: "Steamed or pan-seared pork-free dumplings served with signature Szechuan chili oil dip.",
    price: "2.400",
    image: "https://images.unsplash.com/photo-1541696432-82c6da8ce7bf?q=80&w=1000&auto=format&fit=crop",
  },
  {
    name: "Kung Pao Shrimp Wok",
    description: "Sizzling wok-tossed prawns, roasted peanuts, and dried red chilis over fragrant Jasmine rice.",
    price: "3.600",
    image: "https://images.unsplash.com/photo-1563245372-f21724e3856d?q=80&w=1000&auto=format&fit=crop",
  },
  {
    name: "Charred Beef Wok Box",
    description: "Smoky wok-charred beef strips tossed in garlic black pepper glaze with Hakka noodles.",
    price: "3.400",
...
export default function PopularDishes() {
  const handleOrder = (name: string, price: string) => {
    const message = `Hi Wok House MGM! I'd like to place an order: ${name} (${price} OMR). Pickup at MGM Food Court.`;
    ...
    <section id="menu" className="py-24 px-6 bg-[#0D0D0D] border-t border-[#26262E]">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-end mb-12 border-b border-[#26262E] pb-6">
          ...
          <a href="#" className="hidden sm:flex items-center gap-2 text-[#E5A93C] hover:text-white text-sm font-semibold tracking-wider uppercase transition-colors min-h-[48px] px-4">
          ...
          {popularDishes.map((dish, index) => (
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden bg-[#0D0D0D]">
                ...
                <div className="absolute top-4 right-4 bg-[#0D0D0D]/80 backdrop-blur border border-[#26262E] text-[#E5A93C] px-3 py-1.5 text-sm font-mono font-bold rounded shadow-lg">
                  {dish.price} OMR
                </div>
              </div>
        ...
        <div className="mt-10 flex justify-center sm:hidden">
          <a href="#" className="flex items-center gap-2 text-[#E5A93C] hover:text-white text-sm font-semibold tracking-wider uppercase transition-colors border border-[#26262E] bg-[#16161A] px-6 py-3 rounded-md w-full justify-center min-h-[48px]">
            View All <ArrowRight className="w-4 h-4" />
          </a>
        </div>
      </div>
